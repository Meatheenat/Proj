...
// --- จุดที่แก้ไข: เพิ่ม $conn ใน mysqli_query ---
...
<head>
    ...
    <style>
        ...
        .navbar { background-color: #212529 !important; padding: 15px 0; }
        .search-container { background-color: var(--bg-card) !important; padding: 30px; border-radius: 15px; box-shadow: 0 4px 20px rgba(0,0,0,0.1); margin-top: 20px; margin-bottom: 30px; }
        .book-card { background-color: var(--bg-card) !important; border: none !important; border-radius: 15px; transition: transform 0.3s ease; overflow: hidden; }
        .book-card:hover { transform: translateY(-5px); }
        .book-cover-container { height: 200px; overflow: hidden; background: #eee; display: flex; align-items: center; justify-content: center; }
        [data-bs-theme="dark"] .book-cover-container { background: #2a2a2a; }
...
<nav class="navbar navbar-expand-lg navbar-dark sticky-top shadow-sm">
  <div class="container">
    <a class="navbar-brand fw-bold" href="index.php"><i class="bi bi-book-half me-2 text-primary"></i>LibraryMobile</a>
    <div class="ms-auto d-flex align-items-center">
        <a href="notifications.php" class="btn btn-link text-white position-relative me-3 p-0">
            <i class="bi bi-bell-fill fs-5"></i>
            <?php if($noti_count > 0) { ?><span class="position-absolute top-0 start-100 translate-middle badge rounded-pill bg-danger" style="font-size: 0.65rem;"><?php echo $noti_count; ?></span><?php } ?>
        </a>
        ...
        <div class="dropdown">
            <button class="btn btn-outline-light btn-sm dropdown-toggle fw-bold px-3 rounded-pill" type="button" data-bs-toggle="dropdown"><?php echo htmlspecialchars($_SESSION['fullname']); ?></button>
...
<div class="container">
    <div class="search-container">
        <h5 class="fw-bold mb-3"><i class="bi bi-search me-2"></i>ค้นหาหนังสือ</h5>
        <form action="books.php" method="GET">
            <div class="row g-3">
                <div class="col-md-6"><input type="text" name="search" class="form-control" placeholder="ชื่อหนังสือ หรือ ผู้แต่ง..." value="<?php echo htmlspecialchars($search); ?>"></div>
                <div class="col-md-3">
                ...
                <div class="col-md-3"><button type="submit" class="btn btn-primary w-100 fw-bold">ค้นหา</button></div>
            </div>
        </form>
    </div>
